...
cap = cv2.VideoCapture(r"C:/Users/Vineetha/Downloads/video.mp4")
if not cap.isOpened():
...
## Model Files
modelConfiguration = r"C:\Users\Vineetha\Downloads\vehicle-detection-classification-opencv\yolov3-320.cfg"
modelWeigheights = r"C:\Users\Vineetha\Downloads\vehicle-detection-classification-opencv\yolov3-320.weights"
...
def realTime():
    while True:
        ...
        # Check the format of getUnconnectedOutLayers output
        outputLayers = net.getUnconnectedOutLayers()

        # Handle both old and new formats
        if isinstance(outputLayers[0], list) or isinstance(outputLayers[0], np.ndarray):  # Old format
            outputNames = [layersNames[i[0] - 1] for i in outputLayers]
        else:  # New format
            outputNames = [layersNames[i - 1] for i in outputLayers]
